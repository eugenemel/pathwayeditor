...
public:
	...
	inline void setColor(QColor c)     { _color=c; }
        ...
        inline float  setRateForward(float f) 	   { _rateF = f; }
        inline float  setRateReverse(float f) 	   { _rateR = f; }
	inline  float getRateForward()	 	   	   { return _rateF; }
	inline  float getRateReverse()	   		   { return _rateR; }

        inline void setFlux(float f)  { _flux = f; }
        inline float getFlux()  { return _flux; }

        inline void setLastFlux(float f)  { _lastflux = f; }
        inline float getLastFlux()  { return _lastflux; }
	...
	void  setTimerStep(int x)	{ _timerStep=x; }
	int   getTimerStep()	{ return _timerStep; }
	...
	inline bool showNote() { return _showNote; }
	void setShowNote(bool x) { _showNote = x; }

	Reaction* getReaction()			   { return (Reaction*) _data; }
